...
const Dashboard = () => {
  ...
  // Hardcoded stats to replace the fetched data
  const [stats, setStats] = useState({
    totalStudents: '12,450', // Replaced with a static value
    totalFaculty: '450',     // Replaced with a static value
    pendingApprovals: '23',   // Replaced with a static value
    todayAttendance: '88.5'   // Replaced with a static value
  });

  // Removed: const navigae = useNavigate();

  // Removed: useEffect hook containing all backend logic (axios.get, token checks, error handling, navigation)
  // useEffect(()=>{
  //   const fetchStats = async()=>{ ... }
  //   fetchStats();
  // },[])

  // Retained: Static Data for UI elements
